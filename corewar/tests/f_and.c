...
Test(Corewar, and_with_reg)
{
    ...
    f_and(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[2], 0b101);
    cr_expect(!machine.champion[0]->process->carry);
    cr_expect_eq(machine.champion[0]->process->pc, 5);
}

Test(Corewar, and_with_dir)
{
    machine_t machine;
    ...
    f_and(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[1], 0b010);
    cr_expect(!machine.champion[0]->process->carry);
    cr_expect_eq(machine.champion[0]->process->pc, 12);
}

Test(Corewar, and_with_indir)
{
    machine_t machine;
    ...
    machine.map[5] = 0b100;
    f_and(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[1], 0b100);
    cr_expect_eq(machine.champion[0]->process->pc, 7);
    cr_expect(!machine.champion[0]->process->carry);
}

Test(Corewar, and_result_equal_0)
{
    machine_t machine;
    ...
    machine.champion[0] = ini_champ(&machine);
    machine.champion[0]->process->pc = 0;
    machine.champion[0]->process->registers[0] = 0b010;
    machine.champion[0]->process->registers[1] = 0b101;
    machine.champion[0]->process->registers[2] = 0b101;
    machine.champion[0]->process->instruct->mask[0] = 0b01;
    machine.champion[0]->process->instruct->mask[1] = 0b01;
    machine.champion[0]->process->instruct->mask[2] = 0b01;
    machine.champion[0]->process->instruct->arg[0][0] = 0x01;
    ...
    machine.champion[0]->process->instruct->arg[2][0] = 0x03;
    f_and(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[2], 0b000);
    cr_expect_eq(machine.champion[0]->process->pc, 5);
    cr_expect(machine.champion[0]->process->carry);
}
