...
Test(Asm, long_ldi_direct)
{
    ...
    machine.map[21] = 0x32;
    f_lldi(&machine, machine.champion[0]);
...
Test(Asm, long_ldi_register_idx_mod)
{
    machine_t machine;
