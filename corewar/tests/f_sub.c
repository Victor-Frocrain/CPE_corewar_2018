...
Test(Corewar, subtract_result_equal_0)
{
    ...
    machine.champion[0]->process->instruct->arg[2][0] = 0x03;
    machine.champion[0]->process->registers[0] = 4;
    machine.champion[0]->process->registers[1] = 4;
    machine.champion[0]->process->registers[2] = 0x100;
    f_sub(&machine, machine.champion[0]);
