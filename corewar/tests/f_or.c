...
Test(Corewar, or_with_reg)
{
    ...
    f_or(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[2], 0b111);
    cr_expect(!machine.champion[0]->process->carry);
    cr_expect_eq(machine.champion[0]->process->pc, 5);
}

Test(Corewar, or_with_dir)
{
    machine_t machine;
    ...
    f_or(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[1], 0b011);
    cr_expect(!machine.champion[0]->process->carry);
    cr_expect_eq(machine.champion[0]->process->pc, 12);
}

Test(Corewar, or_with_indir)
{
    machine_t machine;
    ...
    machine.map[5] = 0b100;
    f_or(&machine, machine.champion[0]);
    cr_expect_eq(machine.champion[0]->process->registers[1], 0b101);
    cr_expect_eq(machine.champion[0]->process->pc, 7);
    cr_expect(!machine.champion[0]->process->carry);
}

Test(Corewar, or_result_equal_0)
{
    machine_t machine;
    ...
    machine.champion[0]->process->registers[2] = 1;
    machine.champion[0]->process->instruct->mask[0] = 0b01;
    machine.champion[0]->process->instruct->mask[1] = 0b01;
    machine.champion[0]->process->instruct->mask[2] = 0b01;
    machine.champion[0]->process->instruct->arg[2][0] = 0x03;
